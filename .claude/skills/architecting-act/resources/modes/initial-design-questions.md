...
2. Check cookiecutter template values (act name: Ai Comment, cast name: Comment Writer)
...
**Condition**:
- Skip if: Cast name already provided by cookiecutter template (Comment Writer)
...
```json
{
  "question": "I see you created a cast called 'Comment Writer'. What should this cast accomplish?",
...
```json
{
  "question": "What is the main goal of Comment Writer Cast?",
  "header": "Cast Goal",
  "options": [
