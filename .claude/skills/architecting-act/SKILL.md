...
**Steps:**
1. **Ai Comment Act Questions** → [modes/initial-design-questions.md](./resources/modes/initial-design-questions.md)
...
2. **Comment Writer Cast Design** → Follow "Cast Design Workflow" below
3. **Generate CLAUDE.md files** → See "Generating CLAUDE.md" section below
   - Create `/CLAUDE.md` (Act info + Casts table)
   - Create `/casts/comment-writer/CLAUDE.md` (Cast details)
...
**Steps:**
1. **Read CLAUDE.md** → Understand existing Ai Comment Act and Casts
